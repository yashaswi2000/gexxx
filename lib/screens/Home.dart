              ...
              body: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      SizedBox(height: 20),
                      Center(child: Text('welcome ${userData.name},This is Agriculture Based App , we Provide News,Crops Details and we provider a tracker for your cultivation',
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(color: Colors.white,fontFamily: 'OpenSans',fontWeight: FontWeight.normal,fontSize:13),),),
                      SizedBox(height: 20),
                      MyhorizontalDivider(),
                      Container(
                        width: MediaQuery.of(context).size.width,
